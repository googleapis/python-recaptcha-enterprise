    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_assessment: gapic_v1.method.wrap_method(
                self.create_assessment, default_timeout=None, client_info=client_info
            ),
            self.annotate_assessment: gapic_v1.method.wrap_method(
                self.annotate_assessment, default_timeout=None, client_info=client_info
            ),
            self.create_key: gapic_v1.method.wrap_method(
                self.create_key, default_timeout=None, client_info=client_info
            ),
            self.list_keys: gapic_v1.method.wrap_method(
                self.list_keys, default_timeout=None, client_info=client_info
            ),
            self.get_key: gapic_v1.method.wrap_method(
                self.get_key, default_timeout=None, client_info=client_info
            ),
            self.update_key: gapic_v1.method.wrap_method(
                self.update_key, default_timeout=None, client_info=client_info
            ),
            self.delete_key: gapic_v1.method.wrap_method(
                self.delete_key, default_timeout=None, client_info=client_info
            ),
        }
