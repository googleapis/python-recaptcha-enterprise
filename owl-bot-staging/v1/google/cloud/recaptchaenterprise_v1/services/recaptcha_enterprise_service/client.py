...
class RecaptchaEnterpriseServiceClient(metaclass=RecaptchaEnterpriseServiceClientMeta):
    ...
    def delete_key(self,
        ...
        .. code-block::
            ...
            def sample_delete_key():
                ...
                # Make the request
                response = client.delete_key(request=request)
    ...
    def list_related_account_groups(self,
            request: Union[recaptchaenterprise.ListRelatedAccountGroupsRequest, dict] = None,
            *,
            parent: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
    ...
    def list_related_account_group_memberships(self,
            request: Union[recaptchaenterprise.ListRelatedAccountGroupMembershipsRequest, dict] = None,
            *,
            parent: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
    ...
    def search_related_account_group_memberships(self,
            request: Union[recaptchaenterprise.SearchRelatedAccountGroupMembershipsRequest, dict] = None,
            *,
            parent: str = None,
