...
# [START recaptcha_enterprise_get_site_key]
def get_key(project_id: str, recaptcha_site_key: str) -> None:
    """
...
def main(default_project_id: str, domain_name: str) -> str:
    recaptcha_site_key = create_site_key(project_id=default_project_id, domain_name=domain_name)
    list_site_keys(project_id=default_project_id)
    get_key(project_id=default_project_id, recaptcha_site_key=recaptcha_site_key)
    update_site_key(project_id=default_project_id, recaptcha_site_key=recaptcha_site_key, domain_name=domain_name)
    delete_site_key(project_id=default_project_id, recaptcha_site_key=recaptcha_site_key)
...
if __name__ == "__main__":
    ...
    try:
        ...
        main(default_project_id, domain_name)
