...
@pytest.mark.asyncio
async def test_create_assessment_async(transport: str = "grpc_asyncio"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.create_assessment), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_annotate_assessment_async(transport: str = "grpc_asyncio"):
    client = RecaptchaEnterpriseServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(), transport=transport
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.annotate_assessment), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
...
@pytest.mark.asyncio
async def test_create_key_async(transport: str = "grpc_asyncio"):
    client = RecaptchaEnterpriseServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(), transport=transport
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.create_key), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
...
@pytest.mark.asyncio
async def test_list_keys_async(transport: str = "grpc_asyncio"):
    client = RecaptchaEnterpriseServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(), transport=transport
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.list_keys), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
...
async def test_list_keys_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.list_keys),
        "__call__",
...
async def test_list_keys_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page in (await client.list_keys(request={})).pages:
            pages.append(page)
        for page, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_key_async(transport: str = "grpc_asyncio"):
    client = RecaptchaEnterpriseServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(), transport=transport
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client._client._transport.get_key), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
            recaptchaenterprise.Key(
                name="name_value", display_name="display_name_value"
...
@pytest.mark.asyncio
async def test_update_key_async(transport: str = "grpc_asyncio"):
    client = RecaptchaEnterpriseServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(), transport=transport
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.update_key), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
            recaptchaenterprise.Key(
...
@pytest.mark.asyncio
async def test_delete_key_async(transport: str = "grpc_asyncio"):
    client = RecaptchaEnterpriseServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(), transport=transport
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.delete_key), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_recaptcha_enterprise_service_transport_auth_adc():
    ...
    with mock.patch.object(auth, "default") as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.RecaptchaEnterpriseServiceGrpcTransport(host="squid.clam.whelk")
        adc.assert_called_once_with(
            scopes=("https://www.googleapis.com/auth/cloud-platform",)
        )
...
def test_recaptcha_enterprise_service_grpc_asyncio_transport_channel_mtls_with_client_cert_source(
    grpc_create_channel, grpc_ssl_channel_cred
):
    # Check that if channel is None, but api_mtls_endpoint and client_cert_source
    # are provided, then a mTLS channel will be created.
...
@mock.patch("google.api_core.grpc_helpers_async.create_channel", autospec=True)
def test_recaptcha_enterprise_service_grpc_asyncio_transport_channel_mtls_with_adc(
    grpc_create_channel, api_mtls_endpoint
):
    # Check that if channel and client_cert_source are None, but api_mtls_endpoint
    # is provided, then a mTLS channel will be created with SSL ADC.
